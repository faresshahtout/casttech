...
_handlers = []
wristwidht = 'wristwidhtv'
wristhight = 'wristhightv'
clearance = 'clearancev'
ABsection = 'ABsectionv'
Bwidth = 'Bwidthv'
Bhight = 'Bhightv'
castthikness = 'castthiknessv'
BCsection = 'BCsectionv'
Chight = 'Chightv'
Cwidth = 'Cwidthv'
circulediameter = 'circulediameterv'
hangangle = 'hanganglev'
leftpump = 'leftpumpv'
handtip = 'handtipv'
rightpump = 'rightpumpv'
midhandthikness = 'midhandthiknessv'
palmlength = 'palmlengthv'
palmwidth = 'palmwidthv'
thumby = 'thumbyv'
