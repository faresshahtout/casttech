...
class MyCommandCreatedHandler(adsk.core.CommandCreatedEventHandler):
    ...
    def notify(self, args: adsk.core.CommandCreatedEventArgs):
        ...
        try:
            ...
            tab1ChildInputs.addValueInput('value7', 'castthikness', 'mm', adsk.core.ValueInput.createByReal(castthikness))
            ...
            tab1ChildInputs.addValueInput('value11', 'circulediameter', 'mm', adsk.core.ValueInput.createByReal(circulediameter))
            ...
            tab1ChildInputs.addValueInput('value16', 'midhandthikness', 'mm', adsk.core.ValueInput.createByReal(midhandthikness))
            ...
            scriptDir = os.path.dirname(os.path.realpath("C:/Users/fares sh/Desktop/web/orange-madq-fe/modq_fa/Casts/designtest-1.py"))
